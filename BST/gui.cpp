...
{
public:
    static TreeNode *generateNode(const string &s)
    {
        return s == "null" ? nullptr : new TreeNode(stoi(s));
    }
...
private:
    static TreeNode *innerCreate(vector<string> &v)
    {
        if (v.size() == 0)
            return nullptr;
...
{
    // string s = "[700,-1,800,-2,1,null,null,null,null,null,5,3,null,2,4]";
    string s = "[700,-1,800,-2,6,null,null,null,null,5,null,3,null,2,4]";
    // string s = "[3,9,20,null,null,15,7]";
    // string s = "[1,2,null,4,null,null,3,null,null]";
